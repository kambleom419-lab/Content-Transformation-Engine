  ...
  const generate = async () => {
    ...
    try {
      const payload = {
        ...
        params: { target_audience: audience, tone, language, communication_objective: objective },
