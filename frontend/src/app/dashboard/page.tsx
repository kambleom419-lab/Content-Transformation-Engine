...
import { useXAccount } from "@/lib/x-account";
...
export default function DashboardPage() {
  ...
  const [xAccount, setXAccount] = useXAccount();
  ...
  const addFiles = (incoming: FileList | null) => {
    // Snapshot synchronously: a FileList is live, and the input is cleared
    // immediately after this call, which would otherwise empty the list before
